...
class Performance
{
	...
	/** Time to check for new toasts in seconds */
	public static $INTERVAL_FOR_TOASTS_CHECK = 30;
	...
	public static $MAX_NUMBER_EXPORT_RECORDS = 100000;

	/** Max number of mass deleted records */
	public static $maxMassDeleteRecords = 100000;

	/** Max number of transfer ownership records */
	public static $maxMassTransferOwnershipRecords = 100000;
	...
	/** The number of emails that cron can send during one loop. */
	public static $CRON_BATCH_SIZE_SENDING_MAILS = 10;
	...
	/** Max depth for "deep" references */
	public static $MAX_REFERENCES_DEPTH = 2;
}
