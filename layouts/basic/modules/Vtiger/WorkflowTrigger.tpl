...
{strip}
	...
	<div class="modal-footer flex-wrap">
		{if $IS_MASS && \App\User::getCurrentUserModel()->isAdmin()}
			<div class="mb-1 mb-sm-0" style="width: 100px">
				<input type="checkbox" name="sync" id="sync" value="1" checked="checked">
				<label for="sync" class="pl-1">Sync?</span>
			</div>
		{/if}
