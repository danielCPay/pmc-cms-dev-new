	...
	<div class="o-breadcrumb widget_header row">
		...
		<div class="col-md-6 row mt-2">
			<div class="col-7 px-0">
				<button class="btn btn-outline-secondary addMenu float-right ml-2">
					<strong>
						<span class="fa fa-plus u-mr-5px"></span>
						{\App\Language::translate('LBL_ADD_MENU', $QUALIFIED_MODULE)}
					</strong>
				</button>
				<button class="btn btn-warning refreshMenu float-right">
					<strong>
						<span class="fa fa-check u-mr-5px"></span>
						{\App\Language::translate('LBL_REFRESH_MENU', $QUALIFIED_MODULE)}
					</strong>
				</button>
			</div>
