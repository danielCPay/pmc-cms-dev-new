				...
				{if empty($SHOW_CONFIG_ALERT)}
					<span class="btn-toolbar float-lg-right mt-1">
						<span class="btn-group mr-sm-0 mr-lg-1 c-btn-block-md-down">
							<form method="POST" action="index.php?module=Backup&parent=Settings&action=Backup&mode=createBackup">
								<button class="btn btn-warning c-btn-block-md-down" type="submit">
									<span class="fas fa-archive"></span>&nbsp;&nbsp;
									<strong>{\App\Language::translate('LBL_BACKUP', $QUALIFIED_MODULE)}</strong>
								</button>
							</form>
						</span>
					</span>
