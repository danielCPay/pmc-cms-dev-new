				...
				<div class="col-md-5 mb-1 mb-md-0">
					<select name="fieldname" class="select2" data-select="allowClear">
						...
						{foreach from=$MODULE_MODEL->getFields() item=FIELD_MODEL}
							{if ($MODULE_MODEL->getName()=="Documents" && in_array($FIELD_MODEL->getName(),$RESTRICTFIELDS)) || in_array($FIELD_MODEL->getFieldDataType(), ['multiCurrency', 'multiDependField', 'multiDomain', 'multiEmail', 'multiImage', 'multiReferenceValue', 'image'])}
								{continue}
							{/if}
