...
{strip}
	...
	<div class="form-group text-left">
		<input type="hidden" name="addMostRecentDocumentFromParent" value="0">
		<input type="checkbox" name="addMostRecentDocumentFromParent" id="addMostRecentDocumentFromParent" value="1" class="alignTop" {if !empty($TASK_OBJECT->addMostRecentDocumentFromParent)} checked {/if}/>
		<label class="form-check-label ml-1" for="addMostRecentDocumentFromParent">
			{\App\Language::translate('LBL_ADD_MOST_RECENT_DOCUMENT_FROM_PARENT', $QUALIFIED_MODULE)}
		</label>
	</div>
	<div class="form-group text-left">
