				...
				<div class="col-md-4">
					...
					<select name="fieldname"
						...
						{foreach from=$RELATED_MODULE_MODEL->getFields() item=FIELD_MODEL}
							...
							{if \in_array($FIELD_MODEL->getFieldDataType(), ['owner', 'sharedOwner'])}
								...
								{/foreach}
								{$SPECIAL_OPTION = [\App\Language::translate('LBL_SPECIAL_OPTIONS') => array_merge([
									...
									], $USER_OPTIONS, $ROLE_OPTIONS, $GROUP_OPTIONS)
								]}
