			...
			<div class="form-group row">
				...
				<div class="controls col-md-8">
					<select class="select2 form-control sourceModule col-md-8" name="mailer_type" id="mailerType">
						...
						<option {if $RECORD_MODEL->get('mailer_type') eq 'smtpxoauth'} selected {/if}
								value="smtpxoauth">{\App\Language::translate('LBL_SMTP_XOAUTH2', $QUALIFIED_MODULE)}</option>
			...
			<div class="form-group row">
				...
				<div class="controls col-md-8">
					<div class="input-group">
						...
						<span class="input-group-append">
							<button
								class="btn btn-outline-secondary js-oauth-request" type="button"
								data-target-name="password"
								title="{\App\Language::translate('LBL_GOOGLE_XOAUTH_TOKEN', $QUALIFIED_MODULE)}">
