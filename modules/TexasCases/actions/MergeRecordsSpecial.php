 ...
 * Merge cases class.
 */
class TexasCases_MergeRecordsSpecial_Action extends Vtiger_MergeRecords_Action
{
	/**
	 * {@inheritdoc}
	 */
    ...
    \App\Log::warning("TexasCases::MergeRecordsSpecial:PRIMARY = $primaryRecord, MERGE = $mergeType");
    ...
    $serviceTypes = array_unique($serviceTypes);
      ...
      /** @var TexasCases_Record_Model $primaryRecordModel */
