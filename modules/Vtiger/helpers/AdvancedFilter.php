...
class Vtiger_AdvancedFilter_Helper
{
	...
	public static function getAdvancedFilterOpsByFieldType()
	{
		return [
			...
			'datetime' => ['is', 'is not', 'has changed', 'not has changed', 'less than hours before', 'less than hours later', 'more than hours before', 'more than hours later', 'is empty', 'is not empty', 
				'smallerthannow', 'greaterthannow', 'days ago', 'days later', 'hours ago', 'hours later'],
			'time' => ['is', 'is not', 'has changed', 'not has changed', 'is empty', 'is not empty'],
			...
			'days ago', 'days later', 'is empty', 'is not empty', ],
			'boolean' => ['is', 'is not', 'has changed', 'not has changed', 'has changed to'],
			'reference' => ['is', 'is not', 'contains', 'does not contain', 'starts with', 'ends with', 'has changed', 'not has changed', 'is empty', 'is not empty'],
			...
			'recurrence' => ['is', 'is not', 'has changed', 'not has changed', 'not has changed'],
			'comment' => ['is added'],
			'image' => ['is', 'is not', 'contains', 'does not contain', 'starts with', 'ends with', 'is empty', 'is not empty'],
			'percentage' => ['equal to', 'less than', 'greater than', 'does not equal', 'less than or equal to', 'greater than or equal to', 'has changed', 'not has changed', 'not has changed', 'is not empty'],
	...
	public static function getExpressions()
	{
		return ['concat' => 'concat(a,b)', 'time_diffdays(a,b)' => 'time_diffdays(a,b)', 'time_diffdays(a)' => 'time_diffdays(a)', 'time_diff(a,b)' => 'time_diff(a,b)', 'time_diff(a)' => 'time_diff(a)',
			...
			'today' => "get_date('today')", 'tomorrow' => "get_date('tomorrow')", 'yesterday' => "get_date('yesterday')", 'nvl' => 'nvl(a, 0)' ];
	}
