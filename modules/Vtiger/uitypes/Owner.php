...
class Vtiger_Owner_UIType extends Vtiger_Base_UIType
{
	...
	{
		return empty($value) ? (\App\User::getCurrentUserOriginalId() ?? \App\User::getCurrentUserRealId()) : (int) $value;
	}
