...
class Vtiger_Base_UIType extends \App\Base
{
	...
	{
		// HACK allow any length
		$maximumLength = $this->getFieldModel()->get('maximumlength');
		$this->getFieldModel()->set('maximumlength', 0);
	...
	public function validate($value, $isUserFormat = false)
	{
		...
		if (!is_numeric($value) && (\is_string($value) && $value !== \App\Purifier::decodeHtml(\App\Purifier::purify($value)) && $value !== '&nbsp;')) {
