...
class Vtiger_Reference_UIType extends Vtiger_Base_UIType
{
	...
	/** {@inheritdoc} */
	public function getDisplayValue($value, $record = false, $recordModel = false, $rawText = false, $length = false, $returnRemoved = false)
	{
		...
		if (!$returnRemoved && !\App\Record::isExists($value)) {
			return '';
		}
	...
	public function getHistoryDisplayValue($value, Vtiger_Record_Model $recordModel, $rawText = false)
	{
		...
		return $this->getDisplayValue($value, $recordModel->getId(), $recordModel, $rawText, App\Config::module('ModTracker', 'TEASER_TEXT_LENGTH'), true);
	}
	...
	{
		return ['e', 'n', 's', 'ew', 'c', 'k', 'y', 'ny', 're', 'rne'];
	}

	/** {@inheritdoc} */
	public function getOperatorTemplateName(string $operator = '')
	{
		return 'ConditionBuilder/Reference.tpl';
	}
}
