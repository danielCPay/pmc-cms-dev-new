...
class VTEntityMethodManager
{
	 ...
	 * @param string              $methodName
	 */
	public function executeMethod(Vtiger_Record_Model $recordModel, $methodName, Vtiger_Record_Model $originalRecordModel = null)
	{
		...
		if ($data) {
			...
			\call_user_func("{$data['function_name']}::$methodName", $recordModel, $originalRecordModel);
		}
	}
