...
class Tasks extends Vtiger_CRMEntity
{
	public $table_name = 'u_yf_tasks';
	public $table_index = 'tasksid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public $customFieldTable = ['u_yf_taskscf', 'tasksid'];

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public $tab_name = ['vtiger_crmentity', 'u_yf_tasks', 'u_yf_taskscf'];
