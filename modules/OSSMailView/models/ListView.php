...
class OSSMailView_ListView_Model extends Vtiger_ListView_Model
{
	...
	public function loadListViewCondition()
	{
      ...
      $subQuery = (new \App\QueryGenerator('Cases'))->setFields(['id']);
      ...
      $queryGenerator
				->addJoin([
					...
					'vtiger_ossmailview_relation.ossmailviewid = vtiger_ossmailview.ossmailviewid AND vtiger_ossmailview_relation.deleted = 0',
				])
				->addNativeCondition(['in', 'vtiger_ossmailview_relation.crmid', $subQuery]);
		}
	}
}
