...
class Settings_WidgetsManagement_Module_Model extends Settings_Vtiger_Module_Model
{
	...
	public static function getDefaultUserId($widgetModel, $moduleName = false, $owner = false)
	{
		...
		} elseif (('all' == $defaultSelected || 'minegroups' == $defaultSelected) && \in_array($defaultSelected, $owners['available'])) {
	...
	{
		return ['LBL_MINE' => 'mine', 'LBL_ALL' => 'all', 'LBL_USERS' => 'users', 'LBL_GROUPS' => 'groups', 'LBL_MINE_GROUPS' => 'minegroups'];
	}

	public function getFilterSelectDefault()
	{
		return ['LBL_MINE' => 'mine', 'LBL_ALL' => 'all', 'LBL_MINE_GROUPS' => 'minegroups'];
	}
	...
	public function getWidgetsWithFilterUsers()
	{
		return [
			...
			'Mini List', 'Delegated project tasks', 'Delegated (overdue) project tasks', 'Calendar', 'Weekly Calendar',
