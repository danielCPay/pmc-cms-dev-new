...
class Calendar_RecordPopover_Model extends Vtiger_RecordPopover_Model
{
	...
	public function getFieldsIcon(): array
	{
		return ['date_start' => 'far fa-clock', 'due_date' => 'far fa-clock', 'location' => 'fas fa-globe',
			...
			'visibility' => 'fas fa-eye', 'assigned_user_id' => 'fas fa-user', 'note' => 'fas fa-comment-alt',
			'description_wysiwyg' => 'fas fa-comment-alt', 'meeting_url' => 'AdditionalIcon-VideoConference',
			'portfolio' => 'fas fa-comment-alt', 'claim' => 'fas fa-comment-alt', 'case' => 'fas fa-comment-alt' ];
	}
}
