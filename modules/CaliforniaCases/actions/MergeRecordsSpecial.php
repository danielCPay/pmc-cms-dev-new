 ...
 * Merge cases class.
 */
class CaliforniaCases_MergeRecordsSpecial_Action extends Vtiger_MergeRecords_Action
{
	/**
	 * {@inheritdoc}
	 */
    ...
    \App\Log::warning("CaliforniaCases::MergeRecordsSpecial:PRIMARY = $primaryRecord, MERGE = $mergeType");
    ...
    $serviceTypes = array_unique($serviceTypes);
      ...
      /** @var CaliforniaCases_Record_Model $primaryRecordModel */
