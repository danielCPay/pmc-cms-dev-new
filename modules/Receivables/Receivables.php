...
{
	public $table_name = 'u_yf_receivables';
	public $table_index = 'receivablesid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public $customFieldTable = ['u_yf_receivablescf', 'receivablesid'];

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public $tab_name = ['vtiger_crmentity', 'u_yf_receivables', 'u_yf_receivablescf'];
	...
	public $tab_name_index = [
		...
		'u_yf_receivables' => 'receivablesid',
		'u_yf_receivablescf' => 'receivablesid',
	];
	...
	public $list_fields = [
		...
		'Payment Name' => ['receivables', 'payment_name'],
