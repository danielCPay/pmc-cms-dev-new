...
class PaymentsIn_PaymentsInHandler_Handler
{
	...
	{
		$recordModel = $eventHandler->getRecordModel();
		PaymentsIn_SSingleOrdersPaymentStatus_Model::updateIfPossible($recordModel, true);
		PaymentsIn_FinvoicePaymentStatus_Model::updateIfPossible($recordModel, true);
		PaymentsIn_FinvoiceProformaPaymentStatus_Model::updateIfPossible($recordModel, true);
	}
}
