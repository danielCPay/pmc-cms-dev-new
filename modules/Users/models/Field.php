...
class Users_Field_Model extends Vtiger_Field_Model
{
	...
	public function isReadOnly()
	{
		...
		if ((false === ($currentUserModel->isAdminUser() || \App\Security\AdminAccess::isPermitted('Users')) && 98 == $this->get('uitype')) || 156 == $this->get('uitype')) {
			return true;
		}
	...
	public function isAjaxEditable()
	{
		if (!$this->isEditable() || \in_array($this->getUIType(), [105, 106, 98, 101]) || \in_array($this->getName(), ['date_format', 'email1'])) {
			$permission = false;
		} elseif ('login_method' === $this->getName() || 'super_user' === $this->getName()) {
	...
	public function getDisplayValue($value, $record = false, $recordModel = false, $rawText = false, $length = false)
	{
		...
		} else if (('currency_decimal_separator' === $fieldName || 'currency_grouping_separator' === $fieldName) && ('&nbsp;' === $value)) {
			return \App\Language::translate('LBL_SPACE_NBSP', 'Users');
		} 
	...
	public function isEditable()
	{
		if (null === $this->get('editable')) {
			if (115 === $this->get('uitype') && (!(\App\User::getCurrentUserModel()->isAdmin() || \App\Security\AdminAccess::isPermitted('Users')) || \App\User::getCurrentUserId() === $this->get('rocordId'))) {
				$permission = false;
			} elseif ('super_user' === $this->getName()) {
				$permission = \App\User::getCurrentUserModel()->isAdmin() || \App\Security\AdminAccess::isPermitted('Users');
