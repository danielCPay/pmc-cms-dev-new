...
class Cases extends Vtiger_CRMEntity
{
	public $table_name = 'u_yf_cases';
	public $table_index = 'casesid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public $customFieldTable = ['u_yf_casescf', 'casesid'];

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public $tab_name = ['vtiger_crmentity', 'u_yf_cases', 'u_yf_casescf'];
