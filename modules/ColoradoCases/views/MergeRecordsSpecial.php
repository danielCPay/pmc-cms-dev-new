 ...
 * Merge cases class.
 */
class ColoradoCases_MergeRecordsSpecial_View extends Vtiger_MergeRecords_View
{
  ...
  public static function getProviderFields() {
    ...
    $fields = array_keys(Vtiger_Module_Model::getInstance('ColoradoCases')->getFields());
    $fields = array_filter($fields, function ($val) { return preg_match(self::PROVIDER_FIELD_RE, $val) === 1; });

    \App\Cache::save('ColoradoCases', $key, $fields);
