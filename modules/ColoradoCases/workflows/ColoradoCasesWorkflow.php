...
class ColoradoCasesWorkflow
{
	...
	public static function recalculateFromClaims(Vtiger_Record_Model $recordModel)
	{
		...
		\App\Log::warning("ColoradoCases::Workflows::recalculateFromClaims:$id");
	...
	public static function recalculateFromCollections(Vtiger_Record_Model $recordModel)
	{
		...
		\App\Log::warning("ColoradoCases::Workflows::recalculateFromCollections:$id");
	...
	public static function recalculateSettlementNegotiations(Vtiger_Record_Model $recordModel)
	{
		...
		\App\Log::warning("ColoradoCases::Workflows::recalculateSettlementNegotiations:$id");
	...
	public static function recalculateFromOthers(Vtiger_Record_Model $recordModel)
	{
		...
		\App\Log::warning("ColoradoCases::Workflows::recalculateFromOthers:$id");
	...
	public static function recalculateFromCase(Vtiger_Record_Model $recordModel)
	{
		...
		\App\Log::warning("ColoradoCases::Workflows::recalculateFromCase:$id");
	...
	public static function recalculateAll(Vtiger_Record_Model $recordModel)
	{
		...
		\App\Log::warning("ColoradoCases::Workflows::recalculateAll:$id");
	...
	public static function updateNextHearingDate(Vtiger_Record_Model $recordModel)
	{
		...
		\App\Log::warning("ColoradoCases::Workflows::updateNextHearingDate:" . $id);
		...
		if (!$recordModel->get('lock_automation')) {
			...
			if ($next !== null) {
				...
				\App\Log::trace("ColoradoCases::updateNextHearingDate:next_hearing_date = $nextDate");
	...
	public static function calculateStatusAge(Vtiger_Record_Model $recordModel)
	{
		...
		\App\Log::warning("ColoradoCases::Workflows::calculateStatusAge:" . $id);
		...
		\App\Log::trace("ColoradoCases::Workflows::calculateStatusAge:status_age = $statusAge");
		...
		\App\Log::trace("ColoradoCases::Workflows::calculateStatusAge:settl_negot_demand_age = $demandAge");
		...
		\App\Log::trace("ColoradoCases::Workflows::calculateStatusAge:settl_negot_offer_age = $offerAge");
	...
	public static function findSimilarCases(Vtiger_Record_Model $recordModel)
	{
		...
		\App\Log::warning("ColoradoCases::Workflows::findSimilarCases:$id");
	...
	public static function setNewCaseId(Vtiger_Record_Model $recordModel)
	{
		...
		if (\in_array($typeOfClaim, $lopClaimTypes)) {
			$newId = str_replace('COC', 'COL', $recordModel->getRecordNumber());
		} else if (\in_array($typeOfClaim, $hosClaimTypes)) {
			$year = date('y');
			$currentNumber = 
				(new \App\QueryGenerator('ColoradoCases'))
					->addCondition('case_id', "COH$year-", 's')
					->createQuery()->max("cast(regexp_replace(case_id, '^COH$year-(\\\\d+)$', '\\\\1') as integer)") ?? 0;
			$newId = "COH$year-" . sprintf('%06d', $currentNumber + 1);
		} else {
	...
	public static function setAttorneyByAssignedTo(Vtiger_Record_Model $recordModel)
	{
		...
		\App\Log::warning("ColoradoCases::Workflows::setAttorneyByAssignedTo:$id/$assignedUserId");
	...
	public static function revertToPreviousStatus(Vtiger_Record_Model $recordModel)
	{
		...
		\App\Log::warning("ColoradoCases::Workflows::revertToPreviousStatus:$id/$previousStatus/$previousStage");
