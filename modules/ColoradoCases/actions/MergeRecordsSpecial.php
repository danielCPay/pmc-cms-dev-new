 ...
 * Merge cases class.
 */
class ColoradoCases_MergeRecordsSpecial_Action extends Vtiger_MergeRecords_Action
{
	/**
	 * {@inheritdoc}
	 */
    ...
    \App\Log::warning("ColoradoCases::MergeRecordsSpecial:PRIMARY = $primaryRecord, MERGE = $mergeType");
    ...
    $serviceTypes = array_unique($serviceTypes);
      ...
      /** @var ColoradoCases_Record_Model $primaryRecordModel */
