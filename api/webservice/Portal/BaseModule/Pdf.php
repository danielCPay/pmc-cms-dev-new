...
class Pdf extends \Api\Core\BaseAction
{
	...
	public function get()
	{
		...
		$templateIds = $this->controller->request->getArray('templates', 'Integer');
		foreach($this->controller->request->getArray('templateNames', 'String') as $templateName) {
			$templateIds[] = \Vtiger_PDF_Model::getIdByName($templateName, $recordId);
		}
