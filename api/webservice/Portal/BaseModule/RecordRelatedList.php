...
class RecordRelatedList extends \Api\Core\BaseAction
{
	...
	public function get()
	{
		$pagingModel = new \Vtiger_PagingOffset_Model();
		$limit = 1000;
	...
	public function post()
	{
		...
		$sourceRecordId = $this->recordModel->getId();
		$sourceModuleModel = $this->recordModel->getModule();
		$sourceModule = $sourceModuleModel->getName();
		$relatedModule = $request->getByType('param', 'Alnum');
