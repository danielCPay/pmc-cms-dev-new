...
$.Class('Vtiger_List_Js',{listInstance:!1,getRelatedModulesContainer:!1,massEditPreSave:'Vtiger.MassEdit.PreSave',getInstance:function getInstance(){if(!1===Vtiger_List_Js.listInstance){var moduleClassName,fallbackClassName,instance,module=app.getModuleName(),parentModule=app.getParentModuleName();return 'Settings'==parentModule?(moduleClassName=parentModule+'_'+module+'_List_Js','undefined'==typeof window[moduleClassName]&&(moduleClassName=module+'_List_Js'),fallbackClassName=parentModule+'_Vtiger_List_Js','undefined'==typeof window[fallbackClassName]&&(fallbackClassName='Vtiger_List_Js')):(moduleClassName=module+'_List_Js',fallbackClassName='Vtiger_List_Js'),instance='undefined'==typeof window[moduleClassName]?new window[fallbackClassName]:new window[moduleClassName],Vtiger_List_Js.listInstance=instance,instance}return Vtiger_List_Js.listInstance},/**
		 ...
		 */triggerSendEmail:function triggerSendEmail(params,callBackFunction,row){var listInstance=Vtiger_List_Js.getInstance();if(row&&(listInstance.listViewContentContainer=row.closest('.js-list__form')),params&&params.selected_ids||!0!==listInstance.checkListRecordSelected()){var postData=listInstance.getSearchParams();delete postData.parent,delete postData.mode,postData.view='SendMailModal',postData.cvid=listInstance.getCurrentCvId(),params&&$.extend(postData,params),AppConnector.request(postData).done(function(response){app.showModalWindow(response,function(data){data.find('[name="saveButton"]').on('click',function(){data.find('form').validationEngine('validate')&&($.extend(postData,{field:data.find('#field').val(),template:data.find('#template').val(),mailNotes:data.find('#mail_notes').val(),action:'Mail',mode:'sendMails'}),delete postData.view,AppConnector.request(postData).done(function(response){!0==response.result&&(app.hideModalWindow(),'function'==typeof callBackFunction&&callBackFunction(response));}).fail(function(){app.hideModalWindow();}));});});});}else listInstance.noRecordSelectedAlert();},/*
		 * function to trigger Send Sms
		 * @params: send email url , module name.
		 */triggerSendSms:function triggerSendSms(massActionUrl){var listInstance=Vtiger_List_Js.getInstance();!0==listInstance.checkListRecordSelected()?listInstance.noRecordSelectedAlert():Vtiger_List_Js.triggerMassAction(massActionUrl);},triggerMassQuickCreate:function triggerMassQuickCreate(moduleName,data){var listInstance=Vtiger_List_Js.getInstance();if(!0!=listInstance.checkListRecordSelected()){var progress=$.progressIndicator({blockInfo:{enabled:!0}}),params={callbackFunction:function callbackFunction(){},noCache:!0,data:$.extend(data,listInstance.getSearchParams(),{sourceView:'ListView'})};App.Components.QuickCreate.getForm('index.php?module='+moduleName+'&view=MassQuickCreateModal&sourceModule='+app.getModuleName(),moduleName,params).done(function(data){progress.progressIndicator({mode:'hide'}),App.Components.QuickCreate.showModal(data,params),app.registerEventForClockPicker();});}else listInstance.noRecordSelectedAlert();},triggerTransferOwnership:function triggerTransferOwnership(massActionUrl){var thisInstance=this,listInstance=Vtiger_List_Js.getInstance(),validationResult=listInstance.checkListRecordSelected();if(!0!=validationResult){var progressIndicatorElement=$.progressIndicator();thisInstance.getRelatedModulesContainer=!1;AppConnector.request({type:'POST',url:massActionUrl,dataType:'html',data:{}}).done(function(data){if(progressIndicatorElement.progressIndicator({mode:'hide'}),data){var callback=function(data){var params=app.validationEngineOptions;params.onValidationComplete=function(form,valid){return valid&&thisInstance.transferOwnershipSave(form),!1},data.find('#changeOwner').validationEngine(app.validationEngineOptions);};app.showModalWindow(data,function(data){var selectElement=thisInstance.getRelatedModuleContainer();App.Fields.Picklist.changeSelectElementView(selectElement,'select2'),'function'==typeof callback&&callback(data);});}});}else listInstance.noRecordSelectedAlert();},triggerQuickExportToExcel:function triggerQuickExportToExcel(module){var listInstance=Vtiger_List_Js.getInstance();if(!0!=listInstance.checkListRecordSelected()){var progressIndicatorElement=$.progressIndicator(),postData={module:module,action:'QuickExport',mode:'exportToExcel'};$.extend(postData,listInstance.getSearchParams()),app.openUrlMethodPost('index.php',postData),Vtiger_Helper_Js.showMessage({text:app.vtranslate('JS_STARTED_GENERATING_FILE'),type:'info'}),progressIndicatorElement.progressIndicator({mode:'hide'});}else listInstance.noRecordSelectedAlert();},transferOwnershipSave:function transferOwnershipSave(){var listInstance=Vtiger_List_Js.getInstance(),transferOwner=$('#transferOwnerId').val(),relatedModules=$('#related_modules').val(),params={module:app.getModuleName(),action:'TransferOwnership',transferOwnerId:transferOwner,related_modules:relatedModules};params=$.extend(params,listInstance.getSearchParams()),delete params.view,AppConnector.request(params).done(function(response){app.hideModalWindow(),listInstance.getListViewRecords(),Vtiger_List_Js.clearList(),response.result.success?Vtiger_Helper_Js.showMessage({title:app.vtranslate('JS_MESSAGE'),text:app.vtranslate('JS_RECORDS_TRANSFERRED_SUCCESSFULLY'),type:'info'}):Vtiger_Helper_Js.showMessage(response.result.notify);});},/*
		 * Function to get the related module container
		 */getRelatedModuleContainer:function getRelatedModuleContainer(){return !1==this.getRelatedModulesContainer&&(this.getRelatedModulesContainer=$('#related_modules')),this.getRelatedModulesContainer},triggerMassAction:function triggerMassAction(massActionUrl,callBackFunction,beforeShowCb,css){'undefined'==typeof beforeShowCb&&(beforeShowCb=function(){return !0}),'object'==('undefined'==typeof beforeShowCb?'undefined':_typeof(beforeShowCb))&&(css=beforeShowCb,beforeShowCb=function(){return !0});var progressIndicatorElement=$.progressIndicator(),actionParams={type:'POST',url:massActionUrl,dataType:'html',data:Vtiger_List_Js.getInstance().getSearchParams()};'undefined'==typeof css&&(css={}),css=$.extend({"text-align":'left'},css),AppConnector.request(actionParams).done(function(data){if(progressIndicatorElement.progressIndicator({mode:'hide'}),data){var result=beforeShowCb(data);if(!result)return;app.showModalWindow(data,function(data){'function'==typeof callBackFunction&&callBackFunction(data);},css);}}).fail(function(error,err){progressIndicatorElement.progressIndicator({mode:'hide'}),app.showNotify({title:app.vtranslate('JS_MESSAGE'),text:err,type:'error'});});},triggerMassEdit:function triggerMassEdit(massEditUrl){var selectedCount=this.getSelectedRecordCount();if(selectedCount>$('#listMaxEntriesMassEdit').val()){var params={title:app.vtranslate('JS_MESSAGE'),text:app.vtranslate('JS_MASS_EDIT_LIMIT'),type:'error'};return void app.showNotify(params)}Vtiger_List_Js.triggerMassAction(massEditUrl,function(container){app.event.trigger('MassEditModal.AfterLoad',container,massEditUrl);var massEditForm=container.find('#massEdit');massEditForm.validationEngine(app.validationEngineOptions);var listInstance=Vtiger_List_Js.getInstance();listInstance.registerEventForTabClick(massEditForm);var editInstance=Vtiger_Edit_Js.getInstance();editInstance.registerBasicEvents(massEditForm),listInstance.postMassEdit(container),listInstance.registerSlimScrollMassEdit(),$('#massEditContainer').length&&listInstance.inactiveFieldsValidation($('#massEditContainer').find('form'));},{width:'65%'});},getSelectedRecordCount:function getSelectedRecordCount(){var count=void 0,listInstance=Vtiger_List_Js.getInstance(),cvId=listInstance.getCurrentCvId(),selectedIdObj=$('#selectedIds').data(cvId+'selectedIds');if(selectedIdObj!=null)if('all'!=selectedIdObj)count=selectedIdObj.length;else {var excludedIdsCount=$('#excludedIds').data(cvId+'Excludedids').length,totalRecords=$('#recordsCount').val();count=totalRecords-excludedIdsCount;}return count},/*
		 * function to trigger export action
		 * returns UI
		 */triggerExportAction:function triggerExportAction(exportActionUrl,newTab){var formAttr={};newTab&&(formAttr.target='_blank');var params=Vtiger_List_Js.getInstance().getSearchParams();delete params.view,app.openUrlMethodPost(exportActionUrl,params,formAttr);},/**
		 * Function to reload list
		 */clearList:function clearList(){$('#deSelectAllMsg').trigger('click'),$('#selectAllMsgDiv').hide();},triggerListSearch:function triggerListSearch(){var listInstance=Vtiger_List_Js.getInstance(),listViewContainer=listInstance.getListViewContentContainer();listViewContainer.find('[data-trigger="listSearch"]').trigger('click');},getSelectedRecordsParams:function getSelectedRecordsParams(checkList){var listInstance=Vtiger_List_Js.getInstance();return !1==checkList||!0!==listInstance.checkListRecordSelected()?listInstance.getSearchParams():(listInstance.noRecordSelectedAlert(),!1)},triggerGenerateRecords:function triggerGenerateRecords(){var selected=Vtiger_List_Js.getSelectedRecordsParams();if(!1===selected)return !1;selected.view='GenerateModal',selected.fromview='List';var progressIndicatorElement=$.progressIndicator({position:'html',blockInfo:{enabled:!0}});app.showModalWindow(null,'index.php?'+$.param(selected),function(){progressIndicatorElement.progressIndicator({mode:'hide'});});},showMap:function showMap(){var selectedParams=Vtiger_List_Js.getSelectedRecordsParams(!1),url='index.php?module=OpenStreetMap&view=MapModal&srcModule='+app.getModuleName();app.showModalWindow(null,url,function(container){var mapView=new OpenStreetMap_Map_Js;mapView.setSelectedParams(selectedParams),mapView.registerModalView(container);});},triggerReviewChanges:function triggerReviewChanges(reviewUrl){var listInstance=Vtiger_List_Js.getInstance(),validationResult=listInstance.checkListRecordSelected();if(!0!=validationResult){var message=app.vtranslate('JS_MASS_REVIEWING_CHANGES_CONFIRMATION'),title='<i class="fa fa-check-circle"></i> '+app.vtranslate('JS_LBL_REVIEW_CHANGES');Vtiger_Helper_Js.showConfirmationBox({message:message,title:title}).done(function(){var params=listInstance.getSearchParams(),url=reviewUrl+'&viewname='+params.viewname+'&selected_ids='+params.selected_ids+'&excluded_ids='+params.excluded_ids+'&entityState='+params.entityState;listInstance.getListSearchInstance()&&(url+='&search_params='+params.search_params,'undefined'!=typeof searchValue&&0<params.search_value.length&&(url+='&search_key='+params.search_key,url+='&search_value='+params.search_value,url+='&operator=s'));var deleteMessage=app.vtranslate('JS_LOADING_PLEASE_WAIT'),progressIndicatorElement=$.progressIndicator({message:deleteMessage,position:'html',blockInfo:{enabled:!0}});AppConnector.request(url).done(function(data){if(progressIndicatorElement.progressIndicator({mode:'hide'}),data.result){var _params={text:data.result,type:'info'};app.showNotify(_params);}else listInstance.getListViewRecords();}).fail(function(error,err){app.errorLog(error,err);});}).fail(function(){Vtiger_List_Js.clearList();});}else listInstance.noRecordSelectedAlert();},/*
		 * Function to register the submit event for mass comment
		 */triggerMassComment:function triggerMassComment(massActionUrl){var listInstance=Vtiger_List_Js.getInstance();listInstance.checkListRecordSelected()?listInstance.noRecordSelectedAlert():Vtiger_List_Js.triggerMassAction(massActionUrl,function(data){new App.Fields.Text.Completions($(data).find('.js-completions').eq(0),{emojiPanel:!1}),$(data).on('submit','#massSave',function(e){e.preventDefault();var form=$(e.currentTarget),commentContent=form.find('.js-comment-content'),commentContentValue=commentContent.html();if(''===commentContentValue){var errorMsg=app.vtranslate('JS_LBL_COMMENT_VALUE_CANT_BE_EMPTY');return void commentContent.validationEngine('showPrompt',errorMsg,'error','bottomLeft',!0)}form.find('.js-comment-value').val(commentContentValue),commentContent.validationEngine('hide'),form.find('[name=saveButton]').attr('disabled','disabled'),listInstance.massActionSave(form).done(function(){Vtiger_List_Js.clearList();});});});},showMassWorkflowTriggerView:function showMassWorkflowTriggerView(url){var listInstance=Vtiger_List_Js.getInstance();if(!this.getSelectedRecordCount())return void listInstance.noRecordSelectedAlert();var callback=function(data){var treeInstance=data.find('#treeWorkflowContents');treeInstance.jstree({core:{data:JSON.parse(data.find('.js-tree-workflow-data').val()),themes:{name:'proton',responsive:!0,icons:!1},multiple:!1},checkbox:{three_state:!1},plugins:['search']}),data.find('[type="submit"]').on('click',function(){var tasks={},selected=treeInstance.jstree('get_selected',!0);if($.each(selected,function(index,treeElement){'record'===treeElement.original.attr&&(tasks[treeElement.id]=[]);}),$.each(selected,function(index,treeElement){'#'!==tasks[treeElement.parent]&&'task'===treeElement.original.attr&&tasks[treeElement.parent].push(treeElement.id);}),0===Object.keys(tasks).length)app.showNotify({title:app.vtranslate('JS_INFORMATION'),text:app.vtranslate('JS_NOT_SELECTED_WORKFLOW_TRIGGER'),type:'error'});else {app.showNotify({title:app.vtranslate('JS_MESSAGE'),text:app.vtranslate('JS_STARTED_PERFORM_WORKFLOW'),type:'info'});var searchData=listInstance.getSearchParams();delete searchData.view,searchData.selected_ids=listInstance.readSelectedIds(!0),searchData.excluded_ids=listInstance.readExcludedIds(!0),AppConnector.request({type:'POST',url:url,data:$.extend(searchData,{user:data.find('[name="user"]').val(),tasks:JSON.stringify(tasks),sync:data.find('#sync').is(':not(:checked)')?0:1})}).done(function(data){data&&data.result&&data.result.notify?Vtiger_Helper_Js.showMessage(data.result.notify):app.showNotify({title:app.vtranslate('JS_MESSAGE'),text:app.vtranslate('JS_COMPLETED_PERFORM_WORKFLOW'),type:'success'}),app.hideModalWindow(),listInstance.getListViewRecords(),Vtiger_List_Js.clearList();}).fail(function(error){app.errorLog(error),app.showNotify({title:app.vtranslate('JS_ERROR'),text:app.vtranslate('JS_ERROR_DURING_TRIGGER_OF_WORKFLOW'),type:'error'}),app.hideModalWindow(),Vtiger_List_Js.clearList();});}});};AppConnector.request({module:app.getModuleName(),view:'WorkflowTrigger',isMass:'true'}).done(function(data){data&&app.showModalWindow(data,'',callback);});}},{//contains the List View element.
...
listFloatThead:!1,getListSearchInstance:function getListSearchInstance(events){return null!=events&&(this.noEventsListSearch=events),!1==this.listSearchInstance&&(this.getListViewContainer().find('.searchField').length||this.getListViewContainer().find('.picklistSearchField').length)&&(this.listSearchInstance=YetiForce_ListSearch_Js.getInstance(this.getListViewContainer(),this.noEventsListSearch)),this.listSearchInstance},getListViewContainer:function getListViewContainer(){return !1==this.listViewContainer&&(this.listViewContainer=$('div.listViewPageDiv')),this.listViewContainer},getListViewTopMenuContainer:function getListViewTopMenuContainer(){return !1==this.listViewTopMenuContainer&&(this.listViewTopMenuContainer=$('.listViewTopMenuDiv')),this.listViewTopMenuContainer},getListViewContentContainer:function getListViewContentContainer(){return !1==this.listViewContentContainer&&(this.listViewContentContainer=$('.listViewContentDiv')),this.listViewContentContainer},getFilterBlock:function getFilterBlock(){if(!1==this.filterBlock){var filterSelectElement=this.getFilterSelectElement();0>=filterSelectElement.length?this.filterBlock=$():filterSelectElement.is('select')&&(this.filterBlock=filterSelectElement.data('select2').$dropdown);}return this.filterBlock},getFilterSelectElement:function getFilterSelectElement(){return !1==this.filterSelectElement&&(this.filterSelectElement=$('#customFilter')),this.filterSelectElement},getSearchParams:function getSearchParams(){var params=this.getDefaultParams();return !0!==this.checkListRecordSelected()&&(params.selected_ids=this.readSelectedIds(!0),params.excluded_ids=this.readExcludedIds(!0)),params},getDefaultParams:function getDefaultParams(){var params={module:app.getModuleName(),view:app.getViewName(),viewname:this.getCurrentCvId(),page:$('#pageNumber').val(),orderby:$('#orderBy').val(),entityState:$('#entityState').val()};app.getUrlVar('mid')&&(params.mid=app.getUrlVar('mid')),app.getParentModuleName()&&(params.parent=app.getParentModuleName()),$('#sortOrder').length&&(params.sortorder=$('#sortOrder').val());var listSearchInstance=this.getListSearchInstance();if(!1!==listSearchInstance){var _searchValue=listSearchInstance.getAlphabetSearchValue();params.search_params=JSON.stringify(listSearchInstance.getListSearchParams(!0)),params.fixed_search_params=JSON.stringify(listSearchInstance.getListFixedSearchParams()),'undefined'!=typeof _searchValue&&0<_searchValue.length&&(params.search_key=listSearchInstance.getAlphabetSearchField(),params.search_value=_searchValue,params.operator='s');}return params},/*
		 ...
		 */getPageCount:function getPageCount(){var aDeferred=$.Deferred(),pageCountParams=this.getPageJumpParams();return AppConnector.request(pageCountParams).done(function(data){var response;response='object'==('undefined'==typeof data?'undefined':_typeof(data))?data:JSON.parse(data),aDeferred.resolve(response);}).fail(function(){}),aDeferred.promise()},/**
		 ...
		 */registerChangeCustomFilterEvent:function registerChangeCustomFilterEvent(event){var _this3=this,target=$(event.currentTarget),selectOption='',selectOptionId='',textOption='';target.is('option')?selectOption=target:'select2:selecting'===event.type?(selectOptionId=event.params.args.data.id,selectOption=$('#filterOptionId_'+selectOptionId)):'mouseup'===event.type&&(selectOptionId=event.currentTarget.id.split('-').pop(),selectOption=$('#filterOptionId_'+selectOptionId),this.getFilterSelectElement().val(event.currentTarget.id.split('-').pop()).trigger('change')),0===$('.nav-item[data-cvid=\''+selectOptionId+'\'] .nav-link').tab('show').length&&$('.js-filter-tab .active').removeClass('active'),'object'===('undefined'==typeof selectOption?'undefined':_typeof(selectOption))&&(textOption=selectOption.text()),$('#select2-customFilter-container span').contents().last().replaceWith(textOption),app.setMainParams('pageNumber','1'),app.setMainParams('pageToJump','1'),app.setMainParams('orderBy',selectOption.data('orderby')),app.setMainParams('sortOrder',selectOption.data('sortorder'));var urlParams={viewname:selectOption.val(),//to make alphabetic search empty
search_key:this.getAlphabetSearchField(),search_value:'',search_params:''};//Make the select all count as empty
//Make total number of pages as empty
$('#recordsCount').val(''),$('#totalPageCount').text(''),$('.pagination').data('totalCount',0),this.getListViewRecords(urlParams).done(function(){_this3.breadCrumbsFilter(selectOption.text()),_this3.ListViewPostOperation(),_this3.updatePagination(1);}),event.stopPropagation();},/*
...
this.getFilterSelectElement().data('select2').close(),new CustomView($(event.currentTarget).find('#createFilter').data('createurl'));},registerFeaturedFilterClickEvent:function registerFeaturedFilterClickEvent(){var thisInstance=this,listViewFilterBlock=this.getFilterBlock();!1!=listViewFilterBlock&&listViewFilterBlock.on('mouseup','.js-filter-favorites',function(event){var liElement=$(this).closest('.select2-results__option'),currentOptionElement=thisInstance.getSelectOptionFromChosenOption(liElement),params={cvid:currentOptionElement.attr('value'),module:'CustomView',action:'Featured',sorceModuleName:app.getModuleName()};params.actions=1===currentOptionElement.data('featured')?'remove':'add',AppConnector.request(params).done(function(){window.location.reload();}),event.stopPropagation();});},/*
		 ...
		 */registerDeleteFilterClickEvent:function registerDeleteFilterClickEvent(){var thisInstance=this,listViewFilterBlock=this.getFilterBlock();!1!=listViewFilterBlock&&listViewFilterBlock.on('mouseup','.js-filter-delete',function(event){thisInstance.getFilterSelectElement().data('select2').close();var liElement=$(event.currentTarget).closest('.select2-results__option');Vtiger_Helper_Js.showConfirmationBox({message:app.vtranslate('JS_LBL_ARE_YOU_SURE_YOU_WANT_TO_DELETE_FILTER')}).done(function(){app.openUrlMethodPost(thisInstance.getSelectOptionFromChosenOption(liElement).data('deleteurl'));}),event.stopPropagation();});},/*
		 * Function to register the click event for approve filter
		 */registerApproveFilterClickEvent:function registerApproveFilterClickEvent(){var thisInstance=this,listViewFilterBlock=this.getFilterBlock();!1!=listViewFilterBlock&&listViewFilterBlock.on('mouseup','.js-filter-approve',function(event){thisInstance.getFilterSelectElement().data('select2').close();var liElement=$(event.currentTarget).closest('.select2-results__option');app.openUrlMethodPost(thisInstance.getSelectOptionFromChosenOption(liElement).data('approveurl')),event.stopPropagation();});},/*
		 ...
		 */registerEmailFieldClickEvent:function registerEmailFieldClickEvent(){var listViewContentDiv=this.getListViewContentContainer();listViewContentDiv.on('click','.emailField',function(e){e.stopPropagation();});},/*
		 * Function to register the click event of phone field
		 */registerPhoneFieldClickEvent:function registerPhoneFieldClickEvent(){var listViewContentDiv=this.getListViewContentContainer();listViewContentDiv.on('click','.phoneField',function(e){e.stopPropagation();});},/*
		 * Function to register the click event of url field
		 */registerUrlFieldClickEvent:function registerUrlFieldClickEvent(){var listViewContentDiv=this.getListViewContentContainer();listViewContentDiv.on('click','.urlField',function(e){e.stopPropagation();});},/**
