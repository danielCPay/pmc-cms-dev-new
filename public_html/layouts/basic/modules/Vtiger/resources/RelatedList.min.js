...
jQuery.Class('Vtiger_RelatedList_Js',{relatedListInstance:!1,getInstance:function getInstance(parentId,parentModule,selectedRelatedTabElement,relatedModuleName,url){if(!1===Vtiger_RelatedList_Js.relatedListInstance||Vtiger_RelatedList_Js.relatedListInstance.moduleName!==relatedModuleName){var instance,moduleClassName=app.getModuleName()+'_RelatedList_Js',fallbackClassName=Vtiger_RelatedList_Js;instance='undefined'==typeof window[moduleClassName]?new fallbackClassName:new window[moduleClassName],instance.parentRecordId=parentId,instance.parentModuleName=parentModule,instance.selectedRelatedTabElement=selectedRelatedTabElement,instance.moduleName=relatedModuleName,instance.relatedTabsContainer=selectedRelatedTabElement.closest('div.related'),instance.content=$('div.contents',instance.relatedTabsContainer.closest('div.detailViewContainer')),instance.relatedView=instance.content.find('input.relatedView').val(),Vtiger_RelatedList_Js.relatedListInstance=instance;}return Vtiger_RelatedList_Js.relatedListInstance.parseUrlParams(url),Vtiger_RelatedList_Js.relatedListInstance.setSelectedTabElement(selectedRelatedTabElement),Vtiger_RelatedList_Js.relatedListInstance},getInstanceByUrl:function getInstanceByUrl(url,selectedRelatedTabElement){var params=app.convertUrlToObject(url);if(!1===Vtiger_RelatedList_Js.relatedListInstance||Vtiger_RelatedList_Js.relatedListInstance.moduleName!==params.relatedModule){var instance,moduleClassName=app.getModuleName()+'_RelatedList_Js',fallbackClassName=Vtiger_RelatedList_Js;instance='undefined'==typeof window[moduleClassName]?new fallbackClassName:new window[moduleClassName],instance.selectedRelatedTabElement=selectedRelatedTabElement,instance.relatedTabsContainer=selectedRelatedTabElement.closest('div.related'),instance.content=$('div.contents',instance.relatedTabsContainer.closest('div.detailViewContainer')),instance.relatedView=instance.content.find('input.relatedView').val(),Vtiger_RelatedList_Js.relatedListInstance=instance;}return Vtiger_RelatedList_Js.relatedListInstance.parentRecordId=params.record,Vtiger_RelatedList_Js.relatedListInstance.parentModuleName=params.module,Vtiger_RelatedList_Js.relatedListInstance.moduleName=params.relatedModule,Vtiger_RelatedList_Js.relatedListInstance.defaultParams=params,Vtiger_RelatedList_Js.relatedListInstance.setSelectedTabElement(selectedRelatedTabElement),Vtiger_RelatedList_Js.relatedListInstance},triggerMassAction:function triggerMassAction(massActionUrl,type){var self=this.relatedListInstance,validationResult=self.checkListRecordSelected();if(!0!=validationResult){var progressIndicatorElement=$.progressIndicator(),selectedIds=self.readSelectedIds(!0),excludedIds=self.readExcludedIds(!0),cvId=self.getCurrentCvId(),postData=self.getCompleteParams();delete postData.mode,delete postData.view,postData.viewname=cvId,postData.selected_ids=selectedIds,postData.excluded_ids=excludedIds;'sendByForm'===type?(app.openUrlMethodPost(massActionUrl,postData),progressIndicatorElement.progressIndicator({mode:'hide'})):AppConnector.request({type:'POST',url:massActionUrl,data:postData}).done(function(responseData){if(progressIndicatorElement.progressIndicator({mode:'hide'}),responseData&&null!==responseData.result&&(responseData.result.notify&&Vtiger_Helper_Js.showMessage(responseData.result.notify),responseData.result.reloadList&&Vtiger_Detail_Js.reloadRelatedList(),responseData.result.procesStop))return progressIndicatorElement.progressIndicator({mode:'hide'}),!1}).fail(function(){progressIndicatorElement.progressIndicator({mode:'hide'});});}else self.noRecordSelectedAlert();},/**
		 ...
		 */addRelatedRecord:function addRelatedRecord(element,callback,urlPart){var aDeferred=jQuery.Deferred(),referenceModuleName=this.moduleName,parentId=this.getParentId(),parentModule=this.parentModuleName,quickCreateParams={},relatedParams={},relatedField=element.data('name'),fullFormUrl=element.data('url');'undefined'!=typeof fullFormUrl&&'undefined'!=typeof urlPart&&(fullFormUrl+=(-1===fullFormUrl.indexOf('?')?'?':'&')+urlPart),relatedField&&(relatedParams[relatedField]=parentId);var eliminatedKeys=new Array('view','module','mode','action'),preQuickCreateSave=function(data){var index=void 0,queryParam=void 0,queryParamComponents=void 0,queryParameters=[];//To handle switch to task tab when click on add task from related list of activities
...
if('undefined'!=typeof fullFormUrl&&-1!==fullFormUrl.indexOf('?'))for(var urlSplit=fullFormUrl.split('?'),queryString=urlSplit[1],queryParameters=queryString.split('&'),index=0;index<queryParameters.length;index++){var queryParam=queryParameters[index],queryParamComponents=queryParam.split('=');'-1'==jQuery.inArray(queryParamComponents[0],eliminatedKeys)&&(relatedParams[queryParamComponents[0]]=queryParamComponents[1]);}return quickCreateParams.data=relatedParams,quickCreateParams.callbackFunction=function(data){aDeferred.resolve(data);},quickCreateParams.callbackPostShown=preQuickCreateSave,quickCreateParams.noCache=!0,App.Components.QuickCreate.createRecord(referenceModuleName,quickCreateParams),aDeferred.promise()},getRelatedPageCount:function getRelatedPageCount(){var aDeferred=jQuery.Deferred(),element=this.content.find('#totalPageCount'),totalCountElem=this.content.find('#totalCount'),totalPageNumber=element.text();return ''==totalPageNumber?(element.progressIndicator({}),AppConnector.request({module:this.parentModuleName,action:'RelationAjax',mode:'getRelatedListPageCount',record:this.getParentId(),relationId:this.getCompleteParams().relationId,relatedModule:this.moduleName}).done(function(data){var pageCount=data.result.page,numberOfRecords=data.result.numberOfRecords;totalCountElem.val(numberOfRecords),element.text(pageCount),element.progressIndicator({mode:'hide'}),aDeferred.resolve();}).fail(function(){aDeferred.reject(!1);})):aDeferred.resolve(),aDeferred.promise()},favoritesRelation:function favoritesRelation(relcrmId,state){var aDeferred=jQuery.Deferred();return relcrmId?AppConnector.request({module:this.parentModuleName,action:'RelationAjax',mode:'updateFavoriteForRecord',record:this.getParentId(),relcrmid:relcrmId,relatedModule:this.moduleName,relationId:this.getCompleteParams().relationId,actionMode:state?'delete':'add'}).done(function(data){data.result&&aDeferred.resolve(!0);}).fail(function(){aDeferred.reject(!1);}):aDeferred.reject(!1),aDeferred.promise()},updatePreview:function updatePreview(url){var frame=this.content.find('.listPreviewframe');if(this.frameProgress=$.progressIndicator({position:'html',message:app.vtranslate('JS_FRAME_IN_PROGRESS'),blockInfo:{enabled:!0}}),'TreePreview'===this.relatedView)frame.attr('src',url.replace('view=Detail','view=Preview'));else {var defaultView='';app.getMainParams('defaultDetailViewName')&&(defaultView=defaultView+'&mode=showDetailViewByMode&requestMode='+app.getMainParams('defaultDetailViewName')),frame.attr('src',url.replace('view=Detail','view=DetailPreview')+defaultView);}},registerUnreviewedCountEvent:function registerUnreviewedCountEvent(){var ids=[],relatedContent=this.content,isUnreviewedActive=relatedContent.find('.unreviewed').length;relatedContent.find('tr.listViewEntries').each(function(){var id=jQuery(this).data('id');id&&ids.push(id);});1>isUnreviewedActive||AppConnector.request({action:'ChangesReviewedOn',mode:'getUnreviewed',module:'ModTracker',sourceModule:this.moduleName,recordsId:ids}).done(function(appData){var data=appData.result;$.each(data,function(id,value){0<value.a&&relatedContent.find('tr[data-id="'+id+'"] .unreviewed .badge.all').text(value.a).parent().removeClass('d-none'),0<value.m&&relatedContent.find('tr[data-id="'+id+'"] .unreviewed .badge.mail').text(value.m).parent().removeClass('d-none');});});},registerChangeEntityStateEvent:function registerChangeEntityStateEvent(){var thisInstance=this,relatedContent=this.content;relatedContent.on('click','.dropdownEntityState a',function(){var element=$(this);relatedContent.find('.entityState').val(element.data('value')),relatedContent.find('.pagination').data('totalCount',0),relatedContent.find('.dropdownEntityState button').find('span').attr('class',element.find('span').attr('class')),thisInstance.loadRelatedList({page:1});});},registerRowsEvent:function registerRowsEvent(){var self=this;'List'===this.relatedView||'Detail'===this.relatedView?(this.content.find('.listViewEntries').on('click',function(e){if(!$(e.target).closest('div').hasClass('actions')&&!($(e.target).is('button')||$(e.target).parent().is('button')||$(e.target).is('a'))&&!$(e.target).closest('a').hasClass('noLinkBtn')&&!$(e.target,$(e.currentTarget)).is('td:first-child')&&!$(e.target).is('input[type="checkbox"]')&&!$.contains($(e.currentTarget).find('td:last-child').get(0),e.target)&&!$.contains($(e.currentTarget).find('td:first-child').get(0),e.target)){var recordUrl=$(e.target).closest('tr').data('recordurl');recordUrl&&('DetailPreview'===app.getViewName()?top.document.location.href=recordUrl:document.location.href=recordUrl);}}),this.content.find('.js-toggle-hidden-row').on('click',function(){var target=$(this),row=target.closest('tr'),inventoryRow=row.next('.js-hidden-row');if(inventoryRow.length){var block=inventoryRow.find('.js-hidden-row__block[data-element="'+target.data('element')+'"]');(block.is(':visible')||!inventoryRow.is(':visible'))&&inventoryRow.toggleClass('d-none'),inventoryRow.find('.js-hidden-row__block').addClass('d-none'),block.removeClass('d-none'),block.is(':visible')&&self.registerWidgets(block);}})):'ListPreview'===this.relatedView?this.content.find('.listViewEntries').on('click',function(e){var target=$(e.target);if(!target.closest('div').hasClass('actions')&&!(target.is('button')||target.parent().is('button'))&&!target.closest('a').hasClass('noLinkBtn')&&!$(e.target,$(e.currentTarget)).is('td:first-child')&&!target.is('input[type="checkbox"]')&&!$.contains($(e.currentTarget).find('td:last-child').get(0),target[0])&&!$.contains($(e.currentTarget).find('td:first-child').get(0),target[0])){var recordUrl=$(this).data('recordurl');self.content.find('.listViewEntriesTable .listViewEntries').removeClass('active'),$(this).addClass('active'),self.updatePreview(recordUrl);}}):'TreePreview'===this.relatedView&&this.content.find('.listViewEntries').on('click',function(e){var target=$(e.target);if(!target.closest('div').hasClass('actions')&&!(target.is('button')||target.parent().is('button'))&&!target.closest('a').hasClass('noLinkBtn')&&!$(e.target,$(e.currentTarget)).is('td:first-child')&&!target.is('input[type="checkbox"]')&&!$.contains($(e.currentTarget).find('td:last-child').get(0),target[0])&&!$.contains($(e.currentTarget).find('td:first-child').get(0),target[0])){var recordUrl=$(this).data('recordurl');self.content.find('.listViewEntriesTable .listViewEntries').removeClass('active'),$(this).addClass('active'),self.updatePreview(recordUrl);}});var widgetsContainer=this.content.find('.js-hidden-row .js-hidden-row__block[data-element="widgets"]');widgetsContainer.length&&self.registerWidgets(widgetsContainer);},registerWidgets:function registerWidgets(content){var widgetList=$('[class^="widgetContainer_"]',content),detailInstance=Vtiger_Detail_Js.getInstance();widgetList.each(function(index,widget){widget=$(widget),widget.is(':visible')&&detailInstance.loadWidget(widget);});},registerSummationEvent:function registerSummationEvent(){var thisInstance=this;this.content.on('click','.listViewSummation button',function(){var button=$(this),calculateValue=button.closest('td').find('.calculateValue'),params=thisInstance.getCompleteParams();params.action='RelationAjax',params.mode='calculate',params.fieldName=button.data('field'),params.calculateType=button.data('operator'),delete params.view;var progress=$.progressIndicator({message:app.vtranslate('JS_CALCULATING_IN_PROGRESS'),position:'html',blockInfo:{enabled:!0}});app.hidePopover(button),AppConnector.request(params).done(function(response){response.success?calculateValue.html(response.result):calculateValue.html(''),progress.progressIndicator({mode:'hide'});}),progress.progressIndicator({mode:'hide'});});},registerPreviewEvent:function registerPreviewEvent(){var thisInstance=this,contentHeight=this.content.find('.js-detail-preview,.js-list-preview');'TreePreview'===this.relatedView?(contentHeight.height(app.getScreenHeight()-(this.content.offset().top+$('.js-footer').height())),this.content.find('.listPreviewframe').on('load',function(){thisInstance.frameProgress&&thisInstance.frameProgress.progressIndicator({mode:'hide'});}),$(window).on('resize',function(){var oldHeight=contentHeight.height(),newHeight=app.getScreenHeight()-(thisInstance.content.offset().top+$('.js-footer').height());10<Math.abs(oldHeight-newHeight)&&contentHeight.height(newHeight);})):(contentHeight.height(app.getScreenHeight()-(this.content.offset().top+$('.js-footer').height())),this.content.find('.listPreviewframe').on('load',function(){thisInstance.frameProgress&&thisInstance.frameProgress.progressIndicator({mode:'hide'}),contentHeight.height($(this).contents().find('.bodyContents').height()+2);})),this.content.find('.listViewEntriesTable .listViewEntries').first().trigger('click');},registerPaginationEvents:function registerPaginationEvents(){var thisInstance=this,relatedContent=this.content;this.content.on('click','#relatedViewNextPageButton',function(){$(this).hasClass('disabled')||thisInstance.nextPageHandler();}),this.content.on('click','#relatedViewPreviousPageButton',function(){thisInstance.previousPageHandler();}),this.content.on('click','#relatedListPageJump',function(){thisInstance.getRelatedPageCount();}),this.content.on('click','#relatedListPageJumpDropDown > li',function(e){e.stopImmediatePropagation();}).on('keypress','#pageToJump',function(e){thisInstance.pageJumpHandler(e);}),this.content.on('click','.pageNumber',function(){return !$(this).hasClass('disabled')&&void thisInstance.selectPageHandler($(this).data('id'))}),this.content.on('click','#totalCountBtn',function(){app.hidePopover($(this));var params={module:thisInstance.parentModuleName,view:'Pagination',mode:'getRelationPagination',record:thisInstance.getParentId(),relatedModule:thisInstance.moduleName,noOfEntries:$('#noOfEntries',relatedContent).val(),page:relatedContent.find('[name="currentPageNum"]').val()};relatedContent.find('.entityState').length&&(params.entityState=relatedContent.find('.entityState').val()),AppConnector.request(params).done(function(response){relatedContent.find('.paginationDiv').html(response);});});},registerListEvents:function registerListEvents(){var relatedContent=this.content,thisInstance=this;this.content.find('a.favorites').on('click',function(){var progressInstance=jQuery.progressIndicator({position:'html',blockInfo:{enabled:!0}}),element=$(this),row=element.closest('tr');thisInstance.favoritesRelation(row.data('id'),element.data('state')).done(function(response){if(response){var state=element.data('state')?0:1;element.data('state',state),state?(element.find('.far').addClass('d-none'),element.find('.fas').removeClass('d-none')):(element.find('.fas').addClass('d-none'),element.find('.far').removeClass('d-none')),progressInstance.progressIndicator({mode:'hide'});var text=app.vtranslate('JS_REMOVED_FROM_FAVORITES');state&&(text=app.vtranslate('JS_ADDED_TO_FAVORITES')),app.showNotify({text:text,type:'success'});}});}),this.content.find('[name="addButton"]').on('click',function(){var element=$(this);return !0===element.hasClass('quickCreateSupported')?void thisInstance.addRelatedRecord(element):void app.openUrl(element.data('url'))}),this.content.find('.openParent').on('click',function(){var element=$(this);app.openUrl(element.data('url'));}),this.content.find('.relatedHeader button.selectRelation').on('click',function(){var restrictionsField=$(this).data('rf'),params={relationId:thisInstance.getCompleteParams().relationId};restrictionsField&&0<Object.keys(restrictionsField).length&&(params={search_key:restrictionsField.key,search_value:restrictionsField.name,relationId:thisInstance.getCompleteParams().relationId}),thisInstance.showSelectRelation(params);}),this.content.find('button.relationDelete').on('click',function(e){e.stopImmediatePropagation();var target=$(e.currentTarget),params={};target.data('confirm')?(params.message=target.data('confirm'),params.title=target.html()+' '+target.data('content')):target.data('content')?params.message=target.data('content'):params.message=app.vtranslate('JS_DELETE_CONFIRMATION'),Vtiger_Helper_Js.showConfirmationBox(params).done(function(){thisInstance.deleteRelation(target);});}),this.content.find('.js-switch--calendar,select.js-relation-cv-id').on('change',function(){thisInstance.loadRelatedList();});},registerPostLoadEvents:function registerPostLoadEvents(){var thisInstance=this;if(this.registerRowsEvent(),this.registerListScroll(),this.registerTree(),('ListPreview'===this.relatedView||'TreePreview'===this.relatedView)&&(this.registerPreviewEvent(),!this.content.find('.gutter').length)){if(!this.content.find('.js-list-preview').length)return;this.setDomParams(this.content),this.toggleSplit(this.content),'ListPreview'===this.relatedView&&this.registerListPreviewEvents();}this.listSearchInstance=!!this.content.find('.listViewSearchTd [data-trigger="listSearch"]').length&&YetiForce_ListSearch_Js.getInstance(this.content,!1,this),app.event.trigger('RelatedList.AfterLoad',thisInstance);},getSecondColMinWidth:function getSecondColMinWidth(container){var thisWidth,maxWidth=0;return container.find('.js-list__row').each(function(i){thisWidth=$(this).find('.js-list__field').first().width(),0===i?maxWidth=thisWidth:thisWidth>maxWidth?maxWidth=thisWidth:maxWidth;}),maxWidth},setDomParams:function setDomParams(container){this.listColumnFirstWidth=container.find('.listViewEntriesDiv .listViewHeaders th').first().width(),this.listColumnSecondWidth=this.getSecondColMinWidth(container),this.windowW=$(window).width(),this.mainBody=container.closest('.mainBody'),this.windowMinWidth=100*(15/this.windowW),this.windowMaxWidth=100-this.minWidth,this.sideBlocks=container.find('.js-side-block'),this.sideBlockLeft=this.sideBlocks.first(),this.sideBlockRight=this.sideBlocks.last(),this.list=container.find('.js-list-preview'),this.preview=container.find('.js-detail-preview'),this.rotatedText=container.find('.u-rotate-90'),this.footerH=$('.js-footer').outerHeight(),this.headerH=$('.js-header').outerHeight();},getDefaultSplitSizes:function getDefaultSplitSizes(){var thWidth=100*((this.listColumnFirstWidth+this.listColumnSecondWidth+82)/this.windowW);return isNaN(thWidth)&&(thWidth=34),[thWidth,100-thWidth]},getSplitSizes:function getSplitSizes(){var cachedParams=app.moduleCacheGet('userRelatedSplitSet');return void 0===cachedParams?this.getDefaultSplitSizes():cachedParams},registerListPreviewEvents:function registerListPreviewEvents(){var _this3=this;app.showNewScrollbarTopBottom(this.content.find('.js-list-preview--scroll')),app.showNewScrollbarLeft(this.list),this.list.on('click','.listViewEntries',function(){if(10>_this3.split.getSizes()[1]){var defaultGutterPosition=_this3.getDefaultSplitSizes();_this3.split.setSizes(defaultGutterPosition),_this3.preview.show(),_this3.sideBlockRight.removeClass('d-block'),app.moduleCacheSet('userRelatedSplitSet',defaultGutterPosition);}}),this.list.parents('.blockContent').length||this.registerScrollEvent();},registerScrollEvent:function registerScrollEvent(){var _this4=this;this.gutter.addClass('js-fixed-scroll');var scrollContainer=App.Components.Scrollbar.page.element,listOffsetTop=this.list.offset().top-this.headerH,initialH=this.sideBlocks.height(),mainViewPortHeightCss={height:this.mainBody.height()},mainViewPortWidthCss={width:this.mainBody.height()},fixedElements=this.mainBody.find('.js-fixed-scroll');if(!this.mainBody.length){this.mainBody=$(top.document).find('.mainBody'),this.headerH=$(top.document).find('.js-header').outerHeight(),scrollContainer=top.window.App.Components.Scrollbar.page.element;var iframe=$(top.document).find('.js-detail-preview');listOffsetTop=this.list.offset().top+iframe.offset().top-this.headerH+1,mainViewPortHeightCss={height:this.mainBody.height()},mainViewPortWidthCss={width:this.mainBody.height()};}var onScroll=function(){scrollContainer.scrollTop()>=listOffsetTop?(fixedElements.css({top:scrollContainer.scrollTop()-listOffsetTop}),_this4.sideBlocks.css({top:scrollContainer.scrollTop()-listOffsetTop+56}),fixedElements.css(mainViewPortHeightCss),_this4.rotatedText.css(mainViewPortHeightCss),_this4.rotatedText.css(mainViewPortWidthCss)):(fixedElements.css({top:'initial'}),fixedElements.css({height:initialH+scrollContainer.scrollTop()}),_this4.rotatedText.css({width:initialH+scrollContainer.scrollTop(),height:initialH+scrollContainer.scrollTop()}));};scrollContainer.on('scroll',onScroll);},/**
		 ...
		 */registerChangeViewEvent:function registerChangeViewEvent(){var self=this;self.getRelatedContainer().on('click','.js-change-related-view',function(){self.relatedView=this.dataset.view,self.loadRelatedList();});},registerTree:function registerTree(){function setupTree(treeInstance,data){treeInstance.jstree({core:{data:data,themes:{name:'proton',responsive:!0,icons:!0}},checkbox:{three_state:!0,keep_selected_style:!1,whole_node:!1},contextmenu:{select_node:!1,show_at_node:!1,items:function items(node){return node.li_attr['data-recordurl']?{"quick-edit":{label:'Quick Edit',icon:'yfi yfi-quick-creation',action:function action(params){var item=treeInstance.jstree().get_node(params.reference),element=params.reference,data={module:'Documents',record:item.id,removeFromUrl:'step'};App.Components.QuickEdit.showModal(data,element);}},"email-attachment":{label:'Email file as attachment',icon:'fas fa-envelope',action:function action(params){var item=treeInstance.jstree().get_node(params.reference);window.open('index.php?module=OSSMail&view=Compose&type=new&crmModule='+self.parentModuleName+'&crmRecord='+self.parentRecordId+'&attachments='+item.id,'_blank','height=750,width='+Math.max($(window).width()-300,600));}},trash:{label:'Move to Recycle Bin',icon:'fas fa-trash-alt',action:function action(params){var item=treeInstance.jstree().get_node(params.reference);Vtiger_Helper_Js.showConfirmationBox({message:'Moving a record to Recycle Bin only changes the record&#039;s state without changing the rest of information. Are you sure you want to move the record?.',title:'<span class="fas fa-trash-alt "></span> Move to Recycle Bin'}).done(function(){var progressIndicatorElement=$.progressIndicator({position:'html',blockInfo:{enabled:!0}});AppConnector.request('index.php?module=Documents&action=State&state=Trash&record='+item.id).done(function(data){progressIndicatorElement.progressIndicator({mode:'hide'}),data&&data.success?(data.result.notify&&Vtiger_Helper_Js.showMessage(data.result.notify),Vtiger_Detail_Js.reloadRelatedList()):app.showNotify({text:app.vtranslate(data.error.message),title:app.vtranslate('JS_LBL_PERMISSION'),type:'error'});});});}}}:{"quick-add":{label:'Add document',icon:'fas fa-plus',action:function action(params){var item=treeInstance.jstree().get_node(params.reference),element=self.content.find('[name="addButton"]'),additionalParams='',recordUrl=item.li_attr['data-recordurl'];recordUrl||(additionalParams='document_type='+item.id),self.addRelatedRecord(element,void 0,additionalParams);}},"mass-add":{label:'Mass add',icon:'yfi-document-templates',action:function action(params){var item=treeInstance.jstree().get_node(params.reference),additionalParams={},recordUrl=item.li_attr['data-recordurl'];recordUrl||(additionalParams={document_type:item.id}),Vtiger_Index_Js.massAddDocuments('index.php?module=Documents&view=MassAddDocuments',additionalParams);}}}}},sort:function sort(node1id,node2id){var node1=this.get_node(node1id),node1t=node1.text,node1v=node1t.replace('&nbsp;',' ').trim(),node1f=!!node1.li_attr&&!!node1.li_attr['data-recordurl'],node2=this.get_node(node2id),node2t=node2.text,node2v=node2t.replace('&nbsp;',' ').trim(),node2f=!!node2.li_attr&&!!node2.li_attr['data-recordurl'];return node1f==node2f?node1v>node2v?1:node1v<node2v?-1:node1t>node2t?1:node1t<node2t?-1:0:node1f?1:-1},plugins:['checkbox','contextmenu','sort']}),treeInstance.on('activate_node.jstree',function(event,params){var recordUrl=params.node.li_attr['data-recordurl'];recordUrl&&(params.instance.element.find('.jstree-selected').removeClass('jstree-selected'),params.instance.get_node(params.node,!0).find('.jstree-anchor').addClass('jstree-selected'),self.updatePreview(recordUrl));}),treeInstance.on('ready.jstree',function(){var nodes=self.content.find('.jstree-node[role=\'none\']');nodes.on('dragenter',function(e){e.stopPropagation(),e.preventDefault();}),nodes.on('dragover',function(e){e.stopPropagation(),e.preventDefault();}),nodes.on('drop',function(e){if(e.stopPropagation(),e.preventDefault(),!!e.originalEvent.dataTransfer.files.length){var formData=new FormData;if(formData.append('module','Documents'),formData.append('action','MassAdd'),formData.append('createmode','link'),formData.append('return_module',app.getModuleName()),formData.append('return_id',app.getRecordId()),formData.append('relation_id',Vtiger_Detail_Js.getInstance().getContentHolder().find('#relationId').val()),!e.currentTarget.attributes['data-recordurl'])formData.append('document_type',e.currentTarget.attributes.id.value);else {var parentId=$(e.currentTarget).parents('li.jstree-node').attr('id');parentId&&'#'!==parentId&&formData.append('document_type',parentId);}for(var i=0;i<e.originalEvent.dataTransfer.files.length;i++)formData.append('file[]',e.originalEvent.dataTransfer.files[i]),formData.append('nameFile[]',e.originalEvent.dataTransfer.files[i].name);var progressIndicatorElement=$.progressIndicator({blockInfo:{enabled:!0}});AppConnector.request({url:'index.php?module=Documents&view=MassAddDocuments',type:'POST',data:formData,processData:!1,contentType:!1}).done(function(){progressIndicatorElement.progressIndicator({mode:'hide'});if('Detail'===app.getViewName()){var detailView=Vtiger_Detail_Js.getInstance(),selectedTabElement=detailView.getSelectedTab();if('Documents'===selectedTabElement.data('reference'))detailView.reloadTabContent();else if('Documents'===detailView.getContentHolder().find('.detailViewBlockLink').data('reference'))Vtiger_RelatedList_Js.getInstance(detailView.getRecordId(),app.getModuleName(),selectedTabElement,'Documents').loadRelatedList();else {var updatesWidget=detailView.getContentHolder().find('[data-type=\'RelatedModule\'][data-name=\'Documents\']');if(0<updatesWidget.length){var _params=detailView.getFiltersData(updatesWidget);detailView.loadWidget(updatesWidget,_params.params);}}}else Vtiger_List_Js.getInstance().getListViewRecords();}).fail(function(){progressIndicatorElement.progressIndicator({mode:'hide'}),app.showNotify({text:app.vtranslate('JS_ERROR'),type:'error'});});}});});}var self=this;if('TreePreview'===this.relatedView){var treeInstance=self.content.find('#treeContents');setupTree(treeInstance,self.content.find('.js-switch--tree').first().is(':checked')?JSON.parse(self.content.find('.js-tree-data').val()):JSON.parse(self.content.find('.js-full-tree-data').val())),self.content.find('.js-switch--tree').on('change',function(){var isHideEmptySelected=self.content.find('.js-switch--tree').first().is(':checked');app.setCookie('switch-tree',isHideEmptySelected?'true':'false',36500),treeInstance.jstree(!0).settings.core.data=isHideEmptySelected?JSON.parse(self.content.find('.js-tree-data').val()):JSON.parse(self.content.find('.js-full-tree-data').val()),treeInstance.jstree(!0).refresh();});}},/**
		 * Register related events
		 */registerRelatedEvents:function registerRelatedEvents(){var _this9=this;this.registerUnreviewedCountEvent(),this.registerChangeEntityStateEvent(),this.registerPaginationEvents(),this.registerListEvents(),this.registerPostLoadEvents(),this.registerSummationEvent(),this.registerCheckBoxClickEvent(),this.registerMainCheckBoxClickEvent(),this.registerSelectAllClickEvent(),this.registerDeselectAllClickEvent(),this.registerQuickEditSaveEvent(),this.registerChangeViewEvent(),YetiForce_ListSearch_Js.registerSearch(this.content,function(data){_this9.loadRelatedList(data);});}});
