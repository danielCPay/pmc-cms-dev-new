...
Vtiger_List_Js('RecycleBin_List_Js',{/**
		 ...
		 */registerModuleFilter:function registerModuleFilter(){var self=this,container=this.getListViewContainer(),filterSelectElement=container.find('.js-source-module');filterSelectElement.on('select2:selecting',function(e){self.getListViewRecords({module:app.getModuleName(),view:'List',sourceModule:e.params.args.data.id}).done(function(){self.calculatePages().done(function(){container.find('.js-pagination-list').data('totalCount',''),self.updatePagination();});});});},/**
