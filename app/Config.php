...
class Config
{
	 ...
	 * @return mixed
	 */
	public static function quickbooks(?string $arg = null, $default = null)
	{
		$class = '\\Config\\Quickbooks';
		return self::get($class, $arg, $default);
	}

	/**
	 * Gets DocuSign configuration.
	 *
	 * @param string|null $arg
	 * @param mixed       $default
	 *
	 ...
	 * @return mixed
	 */
	public static function docusign(?string $arg = null, $default = null)
	{
		$class = '\\Config\\DocuSign';
		return self::get($class, $arg, $default);
	}

	/**
	 * Gets Google Calendar configuration.
	 *
	 * @param string|null $arg
	 * @param mixed       $default
	 *
	 ...
	 * @return mixed
	 */
	public static function gcal(?string $arg = null, $default = null)
	{
		$class = '\\Config\\Gcal';
		return self::get($class, $arg, $default);
	}
	 ...
	 * @return mixed
	 */
	public static function gdrive(?string $arg = null, $default = null)
	{
		$class = '\\Config\\Gdrive';
		return self::get($class, $arg, $default);
	}
	 ...
	 * @return mixed
	 */
	public static function datadump(?string $arg = null, $default = null)
	{
		$class = '\\Config\\DataDump';
		return self::get($class, $arg, $default);
	}

	/**
	 * Gets Dropbox configuration.
	 *
	 * @param string|null $arg
	 * @param mixed       $default
	 *
	 ...
	 * @return mixed
	 */
	public static function dropbox(?string $arg = null, $default = null)
	{
		$class = '\\Config\\Dropbox';
		return self::get($class, $arg, $default);
	}
