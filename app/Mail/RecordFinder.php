...
class RecordFinder
{
	 ...
	 * @param string $moduleName
	 * @param bool   $multi
	 * @param bool   $byRecordNumber
	 *
	 * @return bool|string|array
	 */
	public static function getRecordNumberFromString(string $value, string $moduleName, bool $multi = false, bool $byRecordNumber = true)
	{
		if ($byRecordNumber) {
			...
			$redex = preg_replace('/\\\\\$\\\\\( *[a-zA-Z]+ *\\\\: *[^)]+ *\\\\\)\\\\\$/', '.*', $redex);
		} else {
			$redex = '/\[[^\[\]]+\]/';
		}
		if ($multi) {
