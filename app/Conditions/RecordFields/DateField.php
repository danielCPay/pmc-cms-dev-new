...
class DateField extends BaseField
{
	 ...
	 * @return bool
	 */
	public function operatorLast4days()
	{
		$today = date('Y-m-d');
		$dateValue = date('Y-m-d', strtotime($this->getValue()));
		return ($dateValue >= date('Y-m-d', strtotime($today . '-3 day'))) && ($dateValue <= $today);
	}
	 ...
	 * @return bool
	 */
	public function operatorLast5days()
	{
		$today = date('Y-m-d');
		$dateValue = date('Y-m-d', strtotime($this->getValue()));
		return ($dateValue >= date('Y-m-d', strtotime($today . '-4 day'))) && ($dateValue <= $today);
	}
	...
	/**
	 * Last180days operator.
	 *
	 * @return bool
	 */
	public function operatorLast180days()
	{
		$today = date('Y-m-d');
		$dateValue = date('Y-m-d', strtotime($this->getValue()));
		return ($dateValue >= date('Y-m-d', strtotime($today . '-179 day'))) && ($dateValue <= $today);
	}
